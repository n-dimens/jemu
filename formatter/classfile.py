...
from core.constant_pool import get_constant_name, get_class_name

__all__ = ['format_raw_class']


def format_raw_class(class_file) -> [str]:
    result = [
    ...
    this_class_name = get_class_name(constant_pool, class_file['this_class'])
    result.append(f"Class: {this_class_name}")

    super_class_name = get_class_name(constant_pool, class_file['super_class'])
